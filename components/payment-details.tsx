  ...
  const paymentSteps = [
    {
      ...
      details: "Visit https://www.onlinesbi.sbi/sbicollect/ and click on 'State Bank Collect'",
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-gradient-to-br from-slate-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-3xl font-bold text-center mb-8 text-slate-800">Registration Fees</h2>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-slate-800 mb-3">SBI Collect Procedure Guide</h3>
        ...
        >
          <h2 className="text-3xl font-bold text-center mb-8 text-slate-800">Accepted Payment Methods</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {paymentMethods.map((method, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100 text-center hover:shadow-xl transition-all duration-300"
              >
        ...
        >
          <h2 className="text-3xl font-bold text-center mb-12 text-slate-800">Step-by-Step Payment Guide</h2>
              ...
              <div className="space-y-8">
                {paymentSteps.map((step, index) => (
                  <div
                    key={index}
                    className={cn(
                      "relative flex items-start space-x-6 p-6 rounded-2xl transition-all duration-300 cursor-pointer",
                      activeStep === index
        ...
        >
          <div className="bg-gradient-to-br from-teal-500 to-teal-600 rounded-2xl p-8 text-white">
            <h2 className="text-2xl font-bold mb-4">Ready to Make Payment?</h2>
        ...
        >
          <h3 className="text-xl font-bold text-slate-800 mb-4 text-center">Need Help with Payment?</h3>
