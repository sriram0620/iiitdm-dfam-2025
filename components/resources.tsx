...
export default function Resources() {
  ...
  const resources = [
    ...
    {
      title: "Topology Optimization Webinar",
      description: "Pre-recorded webinar introducing topology optimization techniques for additive manufacturing.",
    ...
    },
    {
      ...
      description: "List of software tools required for the hands-on sessions with installation instructions.",
      icon: <FileText className="h-10 w-10 text-teal-500" />,
      link: "#",
      buttonText: "Download PDF",
      buttonIcon: <Download className="h-4 w-4 mr-2" />,
    ...
    {
      title: "Previous Program Gallery",
      description: "Photo gallery from previous DfAM programs showcasing activities and projects.",
      icon: <FileCode className="h-10 w-10 text-teal-500" />,
      link: "#",
